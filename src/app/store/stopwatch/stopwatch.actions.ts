...
export const StopwatchActions = createActionGroup({
    ...
    events: {
        ...
        'Load Stopwatches Failure': props<{error: any}>(),
        'Add Stopwatch': emptyProps(),
        'Add Stopwatch Success': props<{stopwatch: Stopwatch}>(),
        'Add Stopwatch Failure': props<{error: any}>(),
